...
* X by model_number profile plots
#+begin_src jupyter-python
MODEL_NUMBER = 1000
PROP = 'mass'
COLS = 4
...
p = l.profile_data(model_number=MODEL_NUMBER) # Duplicate incase you want to modify MODEL_NUMBER
bulk_names = list(p.bulk_names)
bulk_names.remove(PROP)
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/40ea858d2bc8d679f0d412d412e7bcb05e080204.png]]
[[file:./.ob-jupyter/6520bb4ac0977c22b37ed7dbcbac32fc0f3db803.png]]
[[file:./.ob-jupyter/6b20c84f2fe9ed68130a6265e8ee5ba55e02b62b.png]]
:END:
